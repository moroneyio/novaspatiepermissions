...
trait PermissionsBasedAuthTrait
{
    ...
    public static function hasPermissionsTo(Request $request, $ability)
    {
        ...
        if (isset(static::$permissionsForAbilities[$ability]) && isset(static::$permissionsForAbilities['all'])) {
            return $request->user()->hasAnyPermission(static::$permissionsForAbilities[$ability]) || $request->user()->can(static::$permissionsForAbilities['all']);
        }

        if (isset(static::$permissionsForAbilities[$ability])) {
            return $request->user()->hasAnyPermission(static::$permissionsForAbilities[$ability]);
        }

        if (isset(static::$permissionsForAbilities['all'])) {
            return $request->user()->hasAnyPermission(static::$permissionsForAbilities['all']);
        }
